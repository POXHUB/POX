...
function createUI()
    local Window = WindUI:CreateWindow({
        ...
        Resizable = true,
        Background = "https://raw.githubusercontent.com/ParKe001/ParKe/refs/heads/main/picture/POX.jpg",
...
local chatSystem = {
    ...
    chatModes = {
        ...
        ["宣传词"] = function() return {"POX HUB牛逼", "打败一切", "快来购买", "功能多多", "支持超多服务器"} end
    },
    connections = {},
    active = false
}
...
local skySettings = {
    ["天空1"] = "http://www.roblox.com/asset/?id=112666167201442",
    ["天空2"] = "http://www.roblox.com/asset/?id=105006817202266",
    ["动漫猫羽雫天空"] = "http://www.roblox.com/asset/?id=16060333448"
}

local selectedSky = "天空1"
...
Settings:Button({
    ...
    Callback = function()
        ...
        setclipboard("POX HUB 设置: " .. game:GetService("HttpService"):JSONEncode(settings))
        playSound()
    end
})
